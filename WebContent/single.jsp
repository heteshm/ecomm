	...
	<div class="single-page main-grid-border">
		<div class="container">
			<ol class="breadcrumb" style="margin-bottom: 5px;">
				...
				<li class="active"><a href="mobiles.html">  </a></li>
				<li class="active"></li>
			</ol>
        ...
        %> 
			<div class="product-desc">
				<div class="col-md-7 product-view">
					...
					<h2></h2>
					<p> <i class="glyphicon glyphicon-map-marker"></i><h1><%=ap.getName()%></h1></p>
					<div class="flexslider">
 						<ul class="slides">
 							<li data-thumb="images/ss1.jpg"> 
								<img src="<%=ap.getP_FNAME() %>" /> 
 							</li> 
...
<!-- 						</ul> -->
					...
					<div class="product-details">
						<p><strong>Descreption</strong> : <%=ap.getDescp() %></p>
				...
				<div class="col-md-5 product-details-grid">
					<div class="item-price">
						<div class="product-price">
							<p class="p-price"><%=ap.getPrice() %> Rs</p>
							<
							<% 	 if(qty > 0)
                    {
                    ...
                    <form action="Add_cart" method="post">
						...
						<div >
						<input type ="hidden" value="<%=ap.getID()%>" name = "id">
	        <div class="button"  >    
<%-- 			<a href="Giv.jsp?id=<%=ap.getID()%>">Cart</a><br></div> --%>
