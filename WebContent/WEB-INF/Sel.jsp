			...
			<div id="page-wrapper" class="sign-in-wrapper">
				<div class="graphs">
					<div class="sign-up">
						...
						<p class="creating">please insert the detail of the product </p>
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
							<textarea type="text" name="Desc" placeholder="Description" rows="4" cols="50" required=" ">
							</textarea>
...
// 							String st = "select "
				...
				<%
// 				Connection con=dbcon.getConnection();
// 				Statement statement = con.createStatement("select CNAME from CATEGORIES");
